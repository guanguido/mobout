...
function data_transfer_backup_file(string $module, string $srcFile): void
{
    if (!is_file($srcFile)) {
        return;
    }
...
function data_transfer_backup_images_dir(string $module, string $imagesDir): void
{
    if (!is_dir($imagesDir)) {
        return;
    }
...
function data_transfer_import_motd(ZipArchive $zip): array
{
    ...
    data_transfer_backup_file('motd', motd_file());
...
function data_transfer_import_members(ZipArchive $zip): array
{
    ...
    data_transfer_backup_file('members', MEMBERS_DATA_FILE);
    data_transfer_backup_images_dir('members', MEMBERS_IMAGES_DIR);
...
function data_transfer_import_expeditions(ZipArchive $zip): array
{
    ...
    data_transfer_backup_file('expeditions', EXPEDITIONS_DATA_FILE);
    data_transfer_backup_images_dir('expeditions', EXPEDITIONS_IMAGES_DIR);
